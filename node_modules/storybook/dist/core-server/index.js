import CJS_COMPAT_NODE_URL_om3fs3kltp from 'node:url';
import CJS_COMPAT_NODE_PATH_om3fs3kltp from 'node:path';
import CJS_COMPAT_NODE_MODULE_om3fs3kltp from "node:module";

var __filename = CJS_COMPAT_NODE_URL_om3fs3kltp.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_om3fs3kltp.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_om3fs3kltp.createRequire(import.meta.url);
...
import {
  toEstree
} from "../_node-chunks/chunk-OGXHBWYB.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-GMWBW5NR.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-JS7T7TRL.js";
import {
  detectPnp
} from "../_node-chunks/chunk-BREXNC2N.js";
import "../_node-chunks/chunk-XXJQPQJY.js";
import {
  StorybookError
} from "../_node-chunks/chunk-JGLMH4DB.js";
import {
  telemetry
} from "../_node-chunks/chunk-DKDI3UA3.js";
import "../_node-chunks/chunk-HQSV4SOJ.js";
import {
...
} from "../_node-chunks/chunk-MVRFS4XG.js";
import "../_node-chunks/chunk-6PJQBCAT.js";
import "../_node-chunks/chunk-2MVP26TQ.js";
import {
  require_pretty_hrtime
} from "../_node-chunks/chunk-BNC2NJ4M.js";
import "../_node-chunks/chunk-QEMJYEII.js";
import "../_node-chunks/chunk-ERAXT2A7.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-MFL6BBD6.js";
import "../_node-chunks/chunk-GYDBAHYO.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-KD4ROL5O.js";
import {
  dirname,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-6J4N5MVO.js";
import {
  slash
} from "../_node-chunks/chunk-GTM336AP.js";
import "../_node-chunks/chunk-TK4MV3XE.js";
import {
  Tag
} from "../_node-chunks/chunk-J744CZWR.js";
import {
  require_dist
} from "../_node-chunks/chunk-UW2EMBPY.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-HMEZ43GF.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-2I6XATMH.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-F25BCFEJ.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-MUPQ4YLN.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-UBYOFK72.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-3Z2GBGAU.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-UBYOFK72.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
