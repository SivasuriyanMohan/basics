...
var run = async (input = DEFAULT_PARAMETERS, storyId) => {
  let axe = (await import("./axe-DKSCRICC.js"))?.default || globalThis.axe, { config = {}, options = {} } = input;
  if (input.element)
      ...
      if (result) {
        ...
        if (reporting.addReport({
          ...
          if (!vitestMatchersExtended) {
            let { toHaveNoViolations } = await import("./matchers-5TDFFDYO-2X65OT7D.js");
