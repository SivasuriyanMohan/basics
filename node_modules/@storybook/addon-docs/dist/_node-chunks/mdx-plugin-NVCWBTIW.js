...
import {
  compile
} from "./chunk-Z3KZNWTP.js";
import "./chunk-MJSSZ2WJ.js";
import "./chunk-5ZVBPBY4.js";
import {
  __commonJS,
  __toESM
} from "./chunk-Q75KB6R3.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-3BTJNSEA.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-RR4EHYQW.js")).default;
  return {
