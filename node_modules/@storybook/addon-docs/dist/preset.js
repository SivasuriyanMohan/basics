import CJS_COMPAT_NODE_URL_6h3a7ixdcl5 from 'node:url';
import CJS_COMPAT_NODE_PATH_6h3a7ixdcl5 from 'node:path';
import CJS_COMPAT_NODE_MODULE_6h3a7ixdcl5 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_6h3a7ixdcl5.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_6h3a7ixdcl5.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_6h3a7ixdcl5.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-Q75KB6R3.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-3BTJNSEA.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-RR4EHYQW.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-NVCWBTIW.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
